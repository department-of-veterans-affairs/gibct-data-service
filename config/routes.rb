Rails.application.routes.draw do
  ...
  post '/uploads', to: 'uploads#create', constraints: UploadConstraint.new(async_enabled: false)
  post '/uploads', to: 'uploads#create_async', constraints: UploadConstraint.new(async_enabled: true)
