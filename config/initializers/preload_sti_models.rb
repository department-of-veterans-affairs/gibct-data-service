...
if Rails.env.development? || Rails.env.test?
  ...
  %w(
    ...
    hcm_csv_file ipeds_ic_csv_file ipeds_ic_ay_csv_file ipeds_ic_py_csv_file 
    ipeds_hd_csv_file mou_csv_file p911_tf_csv_file p911_yr_csv_file 
    scorecard_csv_file sec702_school_csv_file sec702_csv_file 
    settlement_csv_file sva_csv_file va_crosswalk_csv_file vsoc_csv_file 
    weams_csv_file 
  ).each do |c|
