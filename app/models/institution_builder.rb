      ...
      str = <<-SQL
        INSERT INTO yellow_ribbon_programs
          (version, institution_id, degree_level, division_professional_school,
            number_of_students, contribution_amount, campus,
            city, date_agreement_received, facility_code,
            state, year_of_yr_participation, created_at, updated_at)
          (SELECT
            i.version, i.id, yrs.degree_level, yrs.division_professional_school,
              yrs.number_of_students, yrs.contribution_amount,
              yrs.campus, yrs.city,
              yrs.date_agreement_received,
              yrs.facility_code,
              yrs.state, yrs.year_of_yr_participation,
              NOW(), NOW()
