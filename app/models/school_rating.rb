...
class SchoolRating < ImportableRecord
  CSV_CONVERTER_INFO = {
    ...
    'rated_at' => { column: :rated_at, converter: BaseConverter },
    ...
    'contribution_career_learning_experience' => { column: :contribution_career_learning_experience, converter: BaseConverter  },
