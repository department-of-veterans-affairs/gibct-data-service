...
class Institution < ImportableRecord
  ...
  CSV_CONVERTER_INFO = {
    ...
    'complaints_grades_by_fac_code' => { column: :complaints_grades_by_fac_code, converter: Converters::NumberConverter },
    'complaints_credit_transfer_by_fac_code' => {
      column: :complaints_credit_transfer_by_fac_code, converter: Converters::NumberConverter
    },
    'complaints_job_by_fac_code' => { column: :complaints_job_by_fac_code, converter: Converters::NumberConverter },
    'complaints_transcript_by_fac_code' => { column: :complaints_transcript_by_fac_code, converter: Converters::NumberConverter },
    'complaints_other_by_fac_code' => { column: :complaints_other_by_fac_code, converter: Converters::NumberConverter },
    'complaints_main_campus_roll_up' => { column: :complaints_main_campus_roll_up, converter: Converters::NumberConverter },
  ...
  def versioned_complaints_by_ope6
    ...
    # with an 'A'
    return VersionedComplaint.none if generic_ope6?
