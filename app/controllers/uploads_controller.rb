...
class UploadsController < ApplicationController
  ...
  def sequence_paramss
    @sequence_params ||= upload_params[:sequence].tap do |params|
      params[:current] = params[:current].to_i
      params[:total] = params[:total].to_i
      params[:final_retry] = params[:final_retry] == 'true'
    end
  end
