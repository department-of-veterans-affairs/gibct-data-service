...
RSpec.describe Complaint, type: :model do
  ...
  describe 'update_ope_from_crosswalk' do
    before(:each) do
      weam = create :weam
      create :va_crosswalk, facility_code: weam.facility_code, ope: '11111111'
      create :complaint, facility_code: weam.facility_code, ope: '00000000'
  ...
  describe 'update_sums_by_ope6' do
    before(:each) do
      ...
      create :va_crosswalk, facility_code: weam0.facility_code, ope: '22222222'
      create :va_crosswalk, facility_code: weam1.facility_code, ope: '22222222'
