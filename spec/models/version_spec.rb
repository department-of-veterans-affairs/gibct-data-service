...
RSpec.describe Version, type: :model do
  describe 'buildable?' do
    ...
    let(:upload_dates_after) { [after_preview_date] * CsvTypes.required_table_names.length }
    let(:upload_dates_before) { [before_preview_date] * CsvTypes.required_table_names.length }
