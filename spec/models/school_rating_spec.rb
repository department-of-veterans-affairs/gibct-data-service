...
RSpec.describe SchoolRating, type: :model do
  ...
  describe 'when validating' do\
    ...
    it 'requires rated_at' do
      expect(build(:school_rating, rated_at: nil)).not_to be_valid
    end

    it 'accepts date without time for rated_at' do
      expect(build(:school_rating, rated_at: '2001-10-10')).to be_valid
    end
  end
end
