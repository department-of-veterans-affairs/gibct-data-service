class CreateVersionedComplaints < ActiveRecord::Migration[7.1]
  def change
    create_table :versioned_complaints do |t|
      t.bigint :version_id
      t.string :status
      t.string :ope
      t.string :ope6
    ...
    add_index :versioned_complaints, [:version_id, :facility_code]
    add_index :versioned_complaints, [:version_id, :ope6]
  end
end
