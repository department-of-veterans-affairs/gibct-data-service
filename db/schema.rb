...
ActiveRecord::Schema.define(version: 20160303052200) do
  ...
  add_index "csv_files", ["raw_file_source_id"], name: "index_csv_files_on_raw_file_source_id", unique: true, using: :btree
