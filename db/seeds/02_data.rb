...
Upload.create(filename: 'weam.csv', csv_type: 'Weam', comment: 'Seeds.', user: user, ok: true)

puts 'Loading Crosswalk'
Crosswalk.load('sample_csvs/crosswalk.csv')
Upload.create(filename: 'crosswalk.csv', csv_type: 'Crosswalk', comment: 'Seeds.', user: user, ok: true)

puts 'Loading EightKey'
EightKey.load('sample_csvs/eight_key.csv', skip_lines: 1)
Upload.create(filename: 'eight_key.csv', csv_type: 'EightKey', comment: 'Seeds.', user: user, ok: true)

puts 'Loading Accreditation'
Accreditation.load('sample_csvs/accreditation.csv')
Upload.create(filename: 'accreditation.csv', csv_type: 'Accreditation', comment: 'Seeds.', user: user, ok: true)

puts 'Loading ArfGiBill'
ArfGiBill.load('sample_csvs/arf.csv')
Upload.create(filename: 'arf.csv', csv_type: 'ArfGiBill', comment: 'Seeds.', user: user, ok: true)

puts 'Loading Scorecard'
Scorecard.load('sample_csvs/scorecard.csv')
Upload.create(filename: 'scorecard.csv', csv_type: 'Scorecard', comment: 'Seeds.', user: user, ok: true)

puts 'Loading P911Tf'
P911Tf.load('sample_csvs/p911_tf.csv')
Upload.create(filename: 'p911_tf.csv', csv_type: 'P911Tf', comment: 'Seeds.', user: user, ok: true)

puts 'Loading P911Yr'
P911Yr.load('sample_csvs/p911_yr.csv')
Upload.create(filename: 'p911_yr.csv', csv_type: 'P911Yr', comment: 'Seeds.', user: user, ok: true)

puts 'Loading Vsoc'
Vsoc.load('sample_csvs/vsoc.csv')
Upload.create(filename: 'vsoc.csv', csv_type: 'Vsoc', comment: 'Seeds.', user: user, ok: true)
...
Upload.create(filename: 'sec702.csv', csv_type: 'Sec702', comment: 'Seeds.', user: user, ok: true)

puts 'Loading Sec702School'
Sec702School.load('sample_csvs/sec702_school.csv')
Upload.create(filename: 'sec702_school.csv', csv_type: 'Sec702School', comment: 'Seeds.', user: user, ok: true)

puts 'Loading Mou'
Mou.load('sample_csvs/mou.csv', skip_lines: 1)
Upload.create(filename: 'mou.csv', csv_type: 'Mou', comment: 'Seeds.', user: user, ok: true)

puts 'Loading Hcm'
Hcm.load('sample_csvs/hcm.csv', skip_lines: 2)
Upload.create(filename: 'hcm.csv', csv_type: 'Hcm', comment: 'Seeds.', user: user, ok: true)

puts 'Loading Settlement'
Settlement.load('sample_csvs/settlement.csv')
Upload.create(filename: 'settlement.csv', csv_type: 'Settlement', comment: 'Seeds.', user: user, ok: true)

puts 'Loading IpedsIc'
IpedsIc.load('sample_csvs/ipeds_ic.csv')
Upload.create(filename: 'ipeds_ic.csv', csv_type: 'IpedsIc', comment: 'Seeds.', user: user, ok: true)

puts 'Loading IpedsIcAy'
IpedsIcAy.load('sample_csvs/ipeds_ic_ay.csv')
Upload.create(filename: 'ipeds_ic_ay.csv', csv_type: 'IpedsIcAy', comment: 'Seeds.', user: user, ok: true)

puts 'Loading IpedsIcPy'
IpedsIcPy.load('sample_csvs/ipeds_ic_py.csv')
Upload.create(filename: 'ipeds_ic_py.csv', csv_type: 'IpedsIcPy', comment: 'Seeds.', user: user, ok: true)

puts 'Loading IpedsHd'
IpedsHd.load('sample_csvs/ipeds_hd.csv')
Upload.create(filename: 'ipeds_hd.csv', csv_type: 'IpedsHd', comment: 'Seeds.', user: user, ok: true)

puts 'Loading Complaint'
Complaint.load('sample_csvs/complaint.csv', skip_lines: 7)
Upload.create(filename: 'complaint.csv', csv_type: 'Complaint', comment: 'Seeds.', user: user, ok: true)

puts 'Loading Outcome'
Outcome.load('sample_csvs/outcome.csv')
Upload.create(filename: 'outcome.csv', csv_type: 'Outcome', comment: 'Seeds.', user: user, ok: true)
