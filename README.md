...
2. Install Ruby 2.7.4. (It is suggested to use a Ruby version manager such as [rbenv](https://github.com/rbenv/rbenv#installation) and then to [install Ruby 2.6.6](https://github.com/rbenv/rbenv#installing-ruby-versions)).
